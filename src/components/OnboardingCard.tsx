...
const styles = StyleSheet.create({
  ...
  primaryBtn: { marginTop: 28, backgroundColor: theme.primary, paddingVertical: 14, paddingHorizontal: 32, borderRadius: 14, alignSelf: 'stretch', alignItems: 'center', shadowColor: '#FF1111', shadowOpacity: 0.3, shadowOffset: { width: 0, height: 6 }, shadowRadius: 16, elevation: 6 },
